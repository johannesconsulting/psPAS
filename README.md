...
- CyberArk PAS REST API/PVWA Web Service (available and accessible over HTTPS using TLS 1.2 and TLS 1.3)
...
psPAS is neither developed nor supported by Palo Alto (CyberArk); any official support channels offered by the vendor are not appropriate for seeking help with the psPAS module.
