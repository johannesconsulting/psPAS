...
```
Enable-PASPlatform -TargetPlatform -ID <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### groups

```
Enable-PASPlatform -GroupPlatform -ID <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### rotationalGroups

```
Enable-PASPlatform -RotationalGroup -ID <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```
